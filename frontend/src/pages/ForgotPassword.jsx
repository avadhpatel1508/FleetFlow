        ...
        <div className="min-h-screen flex items-center justify-center bg-[var(--bg-dark)] px-4">
            ...
            >
                    ...
                    {sent ? (
                        <>
                            ...
                            <p className="text-sm text-slate-400 mt-2 text-center">
                                If an account exists for <span className="text-indigo-400">{email}</span>, a reset link has been sent.
                            </p>
                        </>
                    ) : (
                        <>
                            <h1 className="text-2xl font-bold text-white">Forgot Password?</h1>
                            <p className="text-sm text-slate-400 mt-2 text-center">Enter your registered email and we'll send you a reset link.</p>
                        </>
                    )}
                </div>
                ...
                <div className="mt-6 text-center">
                    <Link to="/login" className="flex items-center justify-center gap-2 text-sm text-slate-400 hover:text-indigo-400 transition-colors">
